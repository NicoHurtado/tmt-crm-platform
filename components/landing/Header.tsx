...
export default function Header({ showCart = false, onCartClick }: HeaderProps) {
    ...
    /** Acceso admin oculto: 5 toques seguidos sobre el separador del menú móvil. */
    ...
    const handleSecretTap = () => {
        ...
        // Los toques deben ser seguidos: si pasan 2s sin tocar, se reinicia la cuenta.
    ...
    return (
        <>
            ...
            >
                <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        <Link href="/reservas" className="text-white/90 hover:text-[#D6A75D] transition-colors text-sm font-medium">
            ...
            <div className={`fixed inset-0 bg-black/95 backdrop-blur-md z-30 transition-transform duration-300 md:hidden flex flex-col items-center justify-center gap-8 ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'
                ...
                {/*
                    Separador decorativo que además es el acceso oculto al admin:
                    5 toques seguidos abren /admin/login. Sin etiqueta ni pista visual
                    a propósito — sólo debe conocerlo el administrador.
                */}
                <div
                    onClick={handleSecretTap}
                    aria-hidden="true"
                    className="py-5 px-10 -my-5 select-none"
                >
